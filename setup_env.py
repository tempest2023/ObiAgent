...
def setup_env():
    ...
    with open(activate_script, 'w') as f:
        ...
        f.write('export POCKETFLOW_OLD_FIRECRAWL_ENV="$FIRECRAWL_API_KEY"\n')
        f.write('export POCKETFLOW_OLD_ARCADE_ENV="$ARCADE_API_KEY"\n\n')
        
        # Write environment variables
        for key, value in os.environ.items():
            if key.startswith(('OPENAI_', 'POCKETFLOW_')) or key in ('GEMINI_API_KEY', 'FIRECRAWL_API_KEY', 'ARCADE_API_KEY'):
    ...
    with open(deactivate_script, 'w') as f:
        ...
        f.write('export FIRECRAWL_API_KEY="$POCKETFLOW_OLD_FIRECRAWL_ENV"\n')
        f.write('export ARCADE_API_KEY="$POCKETFLOW_OLD_ARCADE_ENV"\n')
        f.write('unset POCKETFLOW_OLD_ENV\n')
        f.write('unset POCKETFLOW_OLD_GEMINI_ENV\n')
        f.write('unset POCKETFLOW_OLD_FIRECRAWL_ENV\n')
        f.write('unset POCKETFLOW_OLD_ARCADE_ENV\n')
